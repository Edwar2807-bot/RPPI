        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-primary" onclick="location.href='VExp_lab1_Admin.php'">Agregar Nueva exp laboral</button>
                </div>
                <!-- Tabla -->
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <?php
                        ...
                        <!-- Botón Eliminar -->
                        <td>
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $mostrar['Id_exp_laboral']; ?>">Eliminar</button>
                        </td>
                        </form>
                        </tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">                                        
                                        <form action="../Controllers/ExperiencialabController_Admin.php" method="POST">
                        ...
                        <div class="modal fade" id="deleteModal<?php echo $mostrar['Id_exp_laboral']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form method="POST" action="../Controllers/ExperiencialabController_Admin.php">
                                            <input type="hidden" name="Id_exp_laboral" value="<?php echo $mostrar['Id_exp_laboral']; ?>">
                                            <button type="submit" name="deleteExperiencialaboral" class="btn btn-danger">Eliminar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
