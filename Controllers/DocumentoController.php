...
class DocumentoController
{
    ...
    public function setDocumento($Tipo_documento, $Documento, $Id_informacion_personal_doc_fk = 6)
    {
        if (empty($Tipo_documento) || empty($Documento['name'])) {
            echo '<script>alert("Completa todos los campos para poder registrar el documento"); window.location = "../html/VDocs1.php";</script>';
            exit;
        }
        ...
        try {
            ...
            echo '<script>alert("Documento registrado correctamente"); window.location = "../html/VDocs1.php";</script>';
        } catch (Exception $e) {
            echo '<script>alert("Error al cargar el documento: ' . $e->getMessage() . '"); window.location = "../html/VDocs1.php";</script>';
        }
    }
    ...
    public function deleteDocumento($Id_documento)
    {
        if (empty($Id_documento)) {
            ...
            window.location = "../html/VDocs.php";
            </script>';
            exit;
        }
