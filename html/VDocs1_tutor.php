    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                ...
                <form action="../Controllers/DocumentoController_tutor.php" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                        ...
                        <a href="VDocs_Tutor.php" type="submit" class="btn-can">Cancelar </a>
