        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-primary" onclick="location.href='VPost_pasant1_Admin.php'">Agregar Nueva postulacion</button>
                </div>
                ...
                <table class="table table-bordered table-hover">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <!-- Botón Eliminar -->
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $mostrar['Id_post_pasantia']; ?>">Eliminar</button>
                                </td>
                                </form>
                            </tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">                                        
                                            <form action="../Controllers/PostulacionpasController_Admin.php" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    <label class="lb3" for="Area_pas">Area de pasantías</label>
