            ...
            <main id="main-content" class="content">
                <div class="form-login">
                    <form action="../Controllers/RolusuarioController_Admin.php" method="POST">
                        <div class="form-row">
                            <label class="lb1" for="Nombre_rol">Nombre del Rol</label>
                        </div>
                        <div class="form-row1">
                            <input type="text" class="form-control1" id="Nombre_rol" name="Nombre_rol" placeholder="Digite el rol" required>
                        </div>
                        <a href="VRol_Admin.php" type="submit" class="btn-can">Cancelar </a>
                        <button type="submit" name="setRolusuario" class="btn-reg">Registrar</button>
                    </form>
                </div>
            </main>
        </div>
