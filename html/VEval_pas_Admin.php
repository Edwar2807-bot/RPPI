...
<head>
    ...
    <title>Evaluación pasantias | INVIMA</title>
                ...
                <main id="main-content" class="content">
                    <div class="form-login">
                        <form action="../Controllers/EvaluacionpasanteController_Admin.php" method="POST">
                            ...
                            <button type="submit" class="btn-reg" name="setEvaluacionpasante">Evaluar Pasantías</button><br>
                        </form>
                        ...
                        <div class="modal fade" id="llamadoModal" tabindex="-1" aria-labelledby="llamadoModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form id="llamadoForm" method="POST" action="../Controllers/LlamadoatencionController_Admin.php">
                                            <div class="mb-3">
