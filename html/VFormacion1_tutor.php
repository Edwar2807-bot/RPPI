    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                ...
                <form action="../Controllers/FormacionController_tutor.php" method="POST">
                    <div class="form-row">
                    ...
                    <div class="form-row1">
                        <input type="Text" class="form-control1" id="Institucion" name="Institucion" placeholder="Ingrese el nombre de la Institucion"   required>
                    ...
                    <a href="VFormacion_tutor.php" type="submit" class="btn-can">Cancelar </a>
