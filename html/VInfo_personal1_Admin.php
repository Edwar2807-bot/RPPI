...
<head>
    ...
    <title>Informacion Personal | INVIMA</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <form action="../Controllers/InformacionPersonalController_Admin.php" method="post" enctype="multipart/form-data">
