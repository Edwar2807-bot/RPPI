            ...
            <main id="main-content" class="content">
                ...
                <table class="table table-bordered table-hover">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <!-- Botón Eliminar -->
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $mostrar['Id_proyecto']; ?>">Eliminar</button>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="../Controllers/ProyectoController_Admin.php" method="POST">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="POST" action="../Controllers/ProyectoController_Admin.php">
                                                <input type="hidden" name="Id_proyecto" value="<?php echo $mostrar['Id_proyecto']; ?>">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <?php
                        ...
                        <!-- Botón Eliminar -->
                        <td>
                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $mostrar['Id_actividad']; ?>">Eliminar</button>
                        </td>
                        </form>
                        </tr>
                        <!-- Modal para Actualizar -->
                        ...
                        <!-- Modal de confirmación para eliminar el registro -->
                        <div class="modal fade" id="deleteModal<?php echo $mostrar['Id_actividad']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="deleteModalLabel">Confirmar Eliminación</h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <!-- Formulario para eliminar el registro -->
                                        <form method="POST" action="../Controllers/ActividadController_Admin.php">
                                            <input type="hidden" name="Id_actividad" value="<?php echo $mostrar['Id_actividad']; ?>">
                                            <button type="submit" name="deleteActividad" class="btn btn-danger">Eliminar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
