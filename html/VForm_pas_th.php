                ...
                <table class="table table-bordered table-hover">
                        ...
                        <?php
                            try {
                                ...
                                $sql = "SELECT * FROM RPPI.Formalizacion";
                                $stmt = $co->query($sql);
                            ...
                            ?>
                            <tr>
                                <td><?php echo $mostrar ['Id_form_pas'] ?></td>
                                <td><a href="<?php echo $mostrar ['Conflicto_intereses'] ?>">Ver Conflicto de intereses</a></td>
                                <td><a href="<?php echo $mostrar ['Certificacion_ARL'] ?>">Ver ARL</a></td>
                                <td><a href="<?php echo $mostrar ['Acta_confidencialidad'] ?>">Ver Acta de confidencialidad</a></td>
                                <td><a href="<?php echo $mostrar ['Certificacion_EPS'] ?>">Ver EPS</a></td>
                            <!-- Botón Actualizar -->
