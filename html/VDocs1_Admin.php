...
<head>
    ...
    <link rel="stylesheet" href="../css/Docs1.css">
</head>
<body>
    <header>
        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                <div class="form-login">
                    <form action="../Controllers/DocumentoController_Admin.php" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                        ...
                        <a href="VDocs_Admin.php" type="submit" class="btn-can">Cancelar </a>
