        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-primary" onclick="location.href='VSolicitud1_tutor.php'">Agregar Nueva Solicitud</button>
                </div>
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th>Descripcién del cargo</th>
                                <th>N° Practicantes</th>
                                <th>Modalidad Prácticas</th>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">                                        
                                                <form action="../Controllers/SolicitudController_tutor.php" method="POST">
