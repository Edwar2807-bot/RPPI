...
<head>
    ...
    <title>Estado Usuario | INVIMA</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        try {
            ...
            $sql = "SELECT * FROM RPPI.EstadoUsuario";
            $stmt = $co->query($sql);
        ...
        ?>
        <tr>
            <td><?php echo $mostrar['Id_estado_usuario']; ?></td>
            <td><?php echo $mostrar['Nombre_estado']; ?></td>
            <td><?php echo $mostrar['Descripcion_estado']; ?></td>
            <!-- Botón Actualizar -->
            <td>
                <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#updateModal<?php echo $mostrar['Id_estado_usuario']; ?>">Actualizar</button>
            </td>
            <!-- Botón Eliminar -->
            <td>
                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $mostrar['Id_estado_usuario']; ?>">Eliminar</button>
            </td>
        </tr>
        
        <!-- Modal para Actualizar -->
        <div class="modal fade" id="updateModal<?php echo $mostrar['Id_estado_usuario']; ?>" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="updateModalLabel">Estado Usuario</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">                                        
                        <form action="../Controllers/EstadousuarioController_Admin.php" method="POST">
                            <input type="hidden" name="Id_estado_usuario" value="<?php echo $mostrar['Id_estado_usuario']; ?>">
                            <div class="mb-3">
                                <label for="Nombre_rol" class="form-label">Nombre Estado</label>
                                <input type="text" class="form-control" id="Nombre_estado" name="Nombre_estado" placeholder="Nombre Estado" value="<?php echo $mostrar['Nombre_estado']; ?>">
                            </div>
                            <div class="mb-3">
                                <label for="Descripcion_estado" class="form-label">Descripción Estado</label>
                                <input type="text" class="form-control" id="Descripcion_estado" name="Descripcion_estado" placeholder="Descripción estado" value="<?php echo $mostrar['Descripcion_estado']; ?>">
                            </div>
                            <button type="submit" name="updateEstadousuario" class="btn btn-primary">Guardar cambios</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="deleteModal<?php echo $mostrar['Id_estado_usuario']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ¿Estás seguro de que deseas eliminar este estado usuario?
                    </div>
                    <div class="modal-footer">
                        ...
                        <form method="POST" action="../Controllers/EstadousuarioController_Admin.php">
                            <input type="hidden" name="Id_estado_usuario" value="<?php echo $mostrar['Id_estado_usuario']; ?>">
                            <button type="submit" name="deleteEstadousuario" class="btn btn-danger">Eliminar</button>
                        </form>
                    </div>
                </div>
            </div>
