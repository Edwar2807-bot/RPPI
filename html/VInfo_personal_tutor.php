    ...
    <div class="wrapper">
        ...
        <div class="main">
            <nav class="navbar navbar-expand px-4 py-3"><br>
                <h3>Información Personal  de los Pasantes</h3><br>
            ...
            <main id="main-content" class="content">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-primary" onclick="location.href='VInfo_personal1_tutor.php'">Agregar Nueva info personal</button>
                </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">                                        
                                        <form action="../Controllers/InformacionPersonalController_Tutor.php" method="POST">
