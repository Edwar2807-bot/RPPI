                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-12 col-md-3 ">
                                <div class="card border-2">
                                    <div class="card-body py-4">
                                        <a href="VInfo_personal3.php" class="div text-decoration-none">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card border-2">
                                    <div class="card-body py-4">
                                        <a href="VFormacion3.php" class="div text-decoration-none">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card border-2">
                                    <div class="card-body py-4">
                                        <a href="VExp_lab3.php" class="div text-decoration-none">
                                            <h5 class="fw-bold d-flex align-items-center">
                                                Exp laboral
                                                <i class="lni lni-archive"></i>
                                            </h5>
                ...
                <div class="div">
                    <div class="card border-2">
                        <div class="card-body py-1">
                            <a href="VPost_pasant3.php" class="div text-decoration-none">
