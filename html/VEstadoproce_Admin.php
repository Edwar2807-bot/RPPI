...
<head>
    ...
    <title>Estado procedimiento | INVIMA</title>
        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-primary" onclick="location.href='VEstadoproce1_Admin.php'">Agregar Nuevo Estado Usuario</button>
                </div>
                <!-- Tabla -->
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <?php
                        try {
                            ...
                            $sql = "SELECT * FROM RPPI.EstadoProcedimiento";
                            $stmt = $co->query($sql);
                    ...
                    <tr>
                        <tr>
                            <td><?php echo $mostrar ['Id_estado_procedimiento'] ?></td>
                            <td><?php echo $mostrar ['Nombre_estado_proc'] ?></td>
                            <td><?php echo $mostrar ['Descripcion_estado_proc'] ?></td>
                        <!-- Botón Actualizar -->
                        <td>
                            <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#updateModal<?php echo $mostrar['Id_estado_procedimiento']; ?>">Actualizar</button>
                        </td>
                        <!-- Botón Eliminar -->
                        <td>
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $mostrar['Id_estado_procedimiento']; ?>">Eliminar</button>
                        </td>
                        </form>
                        </tr>
                        <!-- Modal para Actualizar -->
                        <div class="modal fade" id="updateModal<?php echo $mostrar['Id_estado_procedimiento']; ?>" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel">Estado procedimiento</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">                                        
                                        <form action="../Controllers/EstadoproceController_Admin.php" method="POST">
                                            <input type="hidden" name="Id_estado_procedimiento" value="<?php echo $mostrar['Id_estado_procedimiento']; ?>">
                                            <div class="mb-3">
                                                <label for="Nombre_rol" class="form-label">Nombre Estado procedimiento</label>
                                                <input type="text" class="form-control" id="Nombre_estado_proc" name="Nombre_estado_proc" placeholder="Nombre Estado " value="<?php echo $mostrar['Nombre_estado_proc']; ?>">
                                            </div>
                                            <div class="mb-3">
                                                <label for="Nombre_rol" class="form-label">Descripcion Estado procedimiento</label>
                                                <input type="text" class="form-control" id="Descripcion_estado_proc" name="Descripcion_estado_proc" placeholder="Descripcion estado" value="<?php echo $mostrar['Descripcion_estado_proc']; ?>">
                                            </div>
                                            <button type="submit" name="updateEstadoprocedimiento" class="btn btn-primary">Guardar cambios</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal fade" id="deleteModal<?php echo $mostrar['Id_estado_procedimiento']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ¿Estás seguro de que deseas eliminar este Estado del procedimiento?
                                    </div>
                                    <div class="modal-footer">
                                        ...
                                        <form method="POST" action="../Controllers/EstadoproceController_Admin.php">
                                            <input type="hidden" name="Id_estado_procedimiento" value="<?php echo $mostrar['Id_estado_procedimiento']; ?>">
                                            <button type="submit" name="deleteEstadoprocedimiento" class="btn btn-danger">Eliminar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
