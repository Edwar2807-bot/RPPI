            ...
            <main id="main-content" class="content">
                <div class="form-login">
                    <form>
                        ...
                        <a href="Vsoli_pas.php" type="submit" class="btn-can">Cancelar </a>   
                        <button type="submit" class="btn-reg">Responder</button>
                    </form>
                </div>
            </main>
        </div>
