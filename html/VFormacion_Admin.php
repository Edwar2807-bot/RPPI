        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-primary" onclick="location.href='VFormacion1_Admin.php'">Agregar Nueva Formacion</button>
                </div>
                <!-- Tabla -->
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <?php
                        ...
                        <!-- Botón Eliminar -->
                        <td>
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $mostrar['Id_formacion']; ?>">Eliminar</button>
                        </td>
                        </form>
                        </tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel">Actualizar Formacion</h5>
                                    ...
                                    <div class="modal-body">                                        
                                        <form action="../Controllers/FormacionController_Admin.php" method="POST">
                                            ...
                                            <button type="submit" name="updateFormacion" class="btn btn-primary">Guardar cambios</button>
                                                ...
                                                <div class="modal fade" id="deleteModal<?php echo $mostrar['Id_formacion']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form method="POST" action="../Controllers/FormacionController_Admin.php">
                                            <input type="hidden" name="Id_formacion" value="<?php echo $mostrar['Id_formacion']; ?>">
                                            <button type="submit" name="deleteFormacion" class="btn btn-danger">Eliminar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
