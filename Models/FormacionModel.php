...
class FormacionModel
{
    ...
    public function setFormacion($Tipo_educacion, $Nivel_educacion, $Institucion, $Programa,  $Fec_terminacion, $Id_informacion_personal_form_fk)
    {
        try {
            $stmt = $this->pdo->prepare("INSERT INTO RPPI.Formacion (Tipo_educacion, Nivel_educacion, Institucion, Programa, Fec_terminacion, Id_informacion_personal_form_fk) VALUES (:Tipo_educacion, :Nivel_educacion, :Institucion, :Programa, :Fec_terminacion, :Id_informacion_personal_form_fk)");
