        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-primary" onclick="location.href='VInfo_personal1.1.php'">Agregar Nueva info personal</button>
                </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">                                        
                                        <form action="../Controllers/InformacionPersonalController.php" method="POST">
