        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-primary" onclick="location.href='VDocs1_Admin.php'">Agregar Nuevo documento</button>
                </div>
                <!-- Tabla -->
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <?php
                        ...
                        <!-- Botón Eliminar -->
                        <td>
                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $mostrar['Id_documento']; ?>">Eliminar</button>
                        </td>
                        </form>
                        </tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">                                        
                                        <form action="../Controllers/DocumentoController_Admin.php" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="File" class="form-control" id="Documento" name="Documento" value="<?php echo $mostrar['Documento']; ?>">
                        ...
                        <div class="modal fade" id="deleteModal<?php echo $mostrar['Id_documento']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form method="POST" action="../Controllers/DocumentoController_Admin.php">
                                            <input type="hidden" name="Id_documento" value="<?php echo $mostrar['Id_documento']; ?>">
                                            <button type="submit" name="deleteDocumento" class="btn btn-danger">Eliminar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
