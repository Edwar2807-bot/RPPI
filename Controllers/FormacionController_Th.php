...
class FormacionController
{
    ...
    {
        if (empty($Tipo_educacion) || empty($Nivel_educacion) || empty($Institucion) || empty($Certificado) || empty($Fec_terminacion)){
            echo '
            <script>alert("Completa todos los campos para poder registrar la Formacion");
            window.location = "../html/VFormacion_Th.php";
            </script>
            ';
            exit;
        } else {
    ...
    {
        if (empty($Id_formacion) || empty($Tipo_educacion) || empty($Nivel_educacion) || empty($Institucion) || empty($Fec_terminacion) || empty($Id_informacion_personal_form_fk)) {
            echo '
