        ...
        <div class="main">
            ...
            <main id="main-content" class="content">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-primary" onclick="location.href='VInfo_personal1_Admin.php'">Agregar Nueva info personal</button>
                </div>
    ...
    <div style="max-height: 400px; overflow-y: auto;">
            ...
            <?php
                ...
                <tr>
                    ...
                    <!-- Botón Eliminar -->
                    <td>
                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $mostrar['Id_informacion_personal']; ?>">Eliminar</button>
                    </td>
                </tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">                                        
                                        <form action="../Controllers/InformacionPersonalController_Admin.php" method="POST">
