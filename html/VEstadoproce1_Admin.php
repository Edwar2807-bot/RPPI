            ...
            <main id="main-content" class="content">
                <div class="form-login">
                    <form action="../Controllers/EstadoproceController_Admin.php" method="POST">
                        ...
                        <input type="text" class="form-control2" id="Descripcion_estado_proc" name="Descripcion_estado_proc" placeholder="Descripcion estado">
                            </div>
                        <a href="VEstadoproce_Admin.php" type="submit" class="btn-can">Cancelar </a>
                        <button type="submit" name="setEstadoprocedimiento" class="btn-reg">Registrar</button>
                    </form>
                </div>
            </main>
        </div>
