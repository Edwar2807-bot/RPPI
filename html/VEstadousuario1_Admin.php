            ...
            <main id="main-content" class="content">
                <div class="form-login">
                    <form action="../Controllers/EstadousuarioController_Admin.php" method="POST">
                        <div class="form-row">
                            <label for="Nombre_rol" class="lb1">Nombre Estado</label>
                            <label for="Nombre_rol" class="lb2">Descripcion Estado</label>
                        </div>
                        <div class="form-row1">
                        <input type="text" class="form-control1" id="Nombre_estado" name="Nombre_estado" placeholder="Nombre Estado">
                        <input type="text" class="form-control2" id="Descripcion_estado" name="Descripcion_estado" placeholder="Descripcion estado">
                            </div>
                        <a href="VEstadousuario_Admin.php" type="submit" class="btn-can">Cancelar </a>
                        <button type="submit" name="setEstadousuario" class="btn-reg">Registrar</button>
                    </form>
                </div>
            </main>
        </div>
