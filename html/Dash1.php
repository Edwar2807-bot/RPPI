    ...
    <div class="wrapper">
        ...
        <div class="main">
            <div class="mx-auto text-center">
                    <h4 class="mb-0">
                        <?php 
                            echo '<span style="font-weight: bold;">Usuario</span>';
                        ?>
                    </h4>
                </div>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-12 col-md-3 ">
                                <div class="card border-2">
                                    <div class="card-body py-4">
                                        <a href="VInfo_personal1.php" class="div text-decoration-none">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card border-2">
                                    <div class="card-body py-4">
                                        <a href="VFormacion.php" class="div text-decoration-none">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card border-2">
                                    <div class="card-body py-4">
                                        <a href="VExp_lab.php" class="div text-decoration-none">
                                            <h5 class="fw-bold d-flex align-items-center">
                                                Exp laboral
                                                <i class="lni lni-archive"></i>
                                            </h5>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card border-2">
                                    <div class="card-body py-4">
                                        <a href="VDocs.php" class="div text-decoration-none">
                                            <h5 class="fw-bold d-flex align-items-center">
                                                Otros Documentos
                                                <i class="lni lni-files"></i>
                                            </h5>
                ...
                <div class="div">
                    <div class="card border-2">
                        <div class="card-body py-1">
                            <a href="VPost_pasant.php" class="div text-decoration-none">
